...
access(all) contract PredictionGame {
    ...
    access(all) resource Admin {
        ...
        access(all) fun openPosition(
            ...
            pre {
                ...
                multiplier >= PredictionGame.minMultiplier: "Multiplier below minimum"
                multiplier <= PredictionGame.maxMultiplier: "Multiplier above maximum"
            ...
            PredictionGame.positionCounter = PredictionGame.positionCounter + 1
            let positionId = PredictionGame.positionCounter
            ...
            // Store position
            PredictionGame.positions[positionId] = position

            // Track by owner
            if PredictionGame.positionsByUser[owner] == nil {
                PredictionGame.positionsByUser[owner] = []
            }
            PredictionGame.positionsByUser[owner]!.append(positionId)

            // Escrow stake into house vault
            PredictionGame.houseVault.deposit(from: <-userVault)
        ...
        access(all) fun settlePosition(positionId: UInt64) {
            ...
            let position = PredictionGame.positions[positionId]
            ...
            if payout > 0.0 {
                let payoutVault <- PredictionGame.houseVault.withdraw(amount: payout)
        ...
        access(all) fun fundHouse(from: @MockPYUSD.Vault) {
            ...
            PredictionGame.houseVault.deposit(from: <-from)
    ...
    init() {
        ...
        self.AdminStoragePath = /storage/predictionGameAdmin
